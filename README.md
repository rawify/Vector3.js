...
Determines the [vector refraction](https://raw.org/book/linear-algebra/dot-product/#refract) of the current **unit vector** across a surface with **unit normal** `n`, using the index ratio η = η<sub>in</sub> / η<sub>out</sub> (like from air η_in=1.0 to water η_out=1.33).
