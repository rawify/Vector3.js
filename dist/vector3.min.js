...
Math.abs(this.x*this.x+this.y*this.y+this.z*this.z-1)},lerp:function(a,b){return d(this.x+b*(a.x-this.x),this.y+b*(a.y-this.y),this.z+b*(a.z-this.z))},toString:function(){return"("+this.x+", "+this.y+", "+this.z+")"}};e.random=function(){return d(Math.random(),Math.random(),Math.random())};e.fromPoints=function(a,b){return d(b.x-a.x,b.y-a.y,b.z-a.z)};e.fromBarycentric=function(a,b,f,c,g){const h=a.x,k=a.y;a=a.z;return d(h+(b.x-h)*c+(f.x-h)*g,k+(b.y-k)*c+(f.y-k)*g,a+(b.z-a)*c+(f.z-a)*g)};"function"===
typeof define&&define.amd?define([],function(){return e}):"object"===typeof exports?(Object.defineProperty(e,"__esModule",{value:!0}),e["default"]=e,e.Vector3=e,module.exports=e):l.Vector3=e})(this);
