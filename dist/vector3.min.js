...
refract:function(a,b){const e=this.g(a);var c=1-b*b*(1-e*e);if(0>c)return null;c=Math.sqrt(c);return d(b*this.x-(b*e+c)*a.x,b*this.y-(b*e+c)*a.y,b*this.z-(b*e+c)*a.z)},scaleAlongAxis:function(a,b){a=a.scale(this.dot(a)/a.dot(a));return this.subtract(a).add(a.scale(b))},norm:function(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)},norm2:function(){return this.x*this.x+this.y*this.y+this.z*this.z},normalize:function(){const a=this.h();return 0===a||1===a?this:d(this.x/a,this.y/a,this.z/
